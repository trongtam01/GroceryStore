...
public class AddProductActivity extends AppCompatActivity {
    ...
    private void inputData() {
        ...
        if(TextUtils.isEmpty(productCategory)){
            Toast.makeText(this, "Thiếu thanh mục", Toast.LENGTH_SHORT).show();
            return;
        }
...
//        }
        if(discountAvailable){
            ...
            if(TextUtils.isEmpty(discountPrice)){
                Toast.makeText(this, "Thiếu giảm giá", Toast.LENGTH_SHORT).show();
                return;
            }
        }
        else {
            ...
            reference.child(firebaseAuth.getUid()).child("Products").child(timestamp).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(AddProductActivity.this, "Sản phẩm đã thêm...", Toast.LENGTH_SHORT).show();
                            clearData();
                        }
                    })
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            while (!uriTask.isSuccessful());
                                Uri downloadImagesUri = uriTask.getResult();
                                ...
                                if(uriTask.isSuccessful()){
                                    ...
                                    hashMap.put("productCategory","" + productCategory);
                                    hashMap.put("productQuantity","" + productQuantity);
                                    hashMap.put("productIcon", "" + downloadImagesUri);
                                    hashMap.put("originalPrice","" + originalPrice);
                                    hashMap.put("discountPrice","" + discountPrice);
                                    hashMap.put("discountNote","" + discountNote);
                                    hashMap.put("discountAvailable","" + discountAvailable);
